...
#include <stdlib.h>
#include <unistd.h>
#include "../include/tad_configs.h"
#include "../include/fila.h"
#define CONFIGS_FILE "../data/configuracoes.dat"
...
// FUNÇÕES NOVAS PARA A STRUCT ESPECIALIDADES
void mostrar_especialidades(Especialidades* especialidades) {
  ...
  printf(" - Alergia e Imunologia: %d\n", especialidades->alergia_imunologia);
  printf(" - Dermatologia: %d\n", especialidades->dermatologia);
}
Especialidades* especialidades_inicializar() {
  Especialidades* especialidade = calloc(1, sizeof(Especialidades));
  if (!especialidade) {
